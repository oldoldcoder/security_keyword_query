...
extern unordered_map<char*, void*>* global_hashmap;
...
typedef struct data_owner {
	...
	// 正向索引
	unordered_map<char*, void*>* hashmap_forward;
	// 反向索引
	unordered_map<char*, void*>* hashmap_backward;
	// 数据拥有者拥有fileCnt
	unordered_map<char*, int* >* fileCnt;
	// 序号
	int i;
	// 是否反向索引已经建立完毕
	int is_back;
...
// do的filecnt + 1
inline void do_add_file_cnt(unordered_map<char*, int* >* fileCnt, char* c);
// 上传到服务器
